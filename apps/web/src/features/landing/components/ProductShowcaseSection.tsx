...
export function ProductShowcaseSection() {
  ...
  return (
    <section id="produto" className="bg-surface py-16 lg:py-24">
      <SectionContainer>
        {/* Header */}
        ...
        <div className="relative">
          ...
          >
            {/* Conteúdo: print do produto, mantém aparência própria (não tokenizado) */}
          ...
          <div className="absolute -top-8 right-0 bg-surface rounded-2xl shadow-[0px_10px_15px_0px_rgba(0,0,0,0.1),0px_4px_6px_0px_rgba(0,0,0,0.1)] border-t-4 border-brand p-4 flex items-center gap-2 w-[134px]">
          ...
          <div className="absolute bottom-0 -left-8 bg-surface rounded-2xl shadow-[0px_10px_15px_0px_rgba(0,0,0,0.1),0px_4px_6px_0px_rgba(0,0,0,0.1)] border-t-4 border-success p-4 flex items-center gap-2 w-[164px]">
            <div className="w-5 h-5 flex-shrink-0">
              <svg className="w-full h-full" fill="none" viewBox="0 0 20 20">
