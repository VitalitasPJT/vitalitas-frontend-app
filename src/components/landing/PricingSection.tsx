      ...
      <div className="max-w-7xl mx-auto px-8 lg:px-24">
        ...
        <div className="grid md:grid-cols-3 gap-8">
          {benefits.map((benefit, index) => (
            <div key={index} className="bg-white rounded-[16px] shadow-[0px_4px_24px_0px_rgba(0,0,0,0.08)] p-8 relative">
              {/* Icon */}
        ...
        <div className="mt-16 text-center">
          <div className="inline-flex items-center gap-3 bg-[#f9fafb] border border-[#e5e5e5] rounded-[16px] px-6 py-4">
        ...
        <div className="text-center mt-12">
          <button className="bg-[#e8001c] px-10 py-4 rounded-[10px] text-[16px] font-semibold text-white hover:bg-[#c50017] transition-colors">
